...
GRANT ALL ON `karajoker_dev`.* to 'karajoker'@'%' identified by '29042902';
GRANT ALL PRIVILEGES ON karajoker_test.* TO 'karajoker'@'%';
GRANT ALL PRIVILEGES ON karajoker_prd.* TO 'karajoker'@'%';
